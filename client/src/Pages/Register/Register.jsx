  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `${import.meta.env.VITE_MY_DOMAIN_IP}/api/auth/register`,
        {
          method: "POST",
          headers: {
        ...
        <div className={styles["register-card"]}>
          ...
          >
            ...
            <div className={styles["form-group"]}>
              ...
              <div
                id="emailError"
                className={styles["form-error hidden"]}
              ></div>
            </div>
            ...
            <div className={styles["form-group terms-group"]}>
              ...
              <label htmlFor="termsAccept" className={styles["terms-label"]}>
                I agree to the{" "}
                <Link to="/term_condition" className={styles["terms-link"]}>
                  Terms of Service
                </Link>{" "}
                and{" "}
                <Link to="/privacypolicy" className={styles["terms-link"]}>
                  Privacy Policy
                </Link>
              </label>
            </div>
            ...
            <button
              ...
              disabled={checkBoxCheck ? false : true}
            >
